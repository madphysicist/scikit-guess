...
.. [errata-reei-12] There is a discrepancy between the value for
   :math:`\sigma_e` in the paper (0.1493) and the one generated in the tests
   (0.1489) in :numref:`reei-sin-exact-data`. This is likely due to roundoff
   error, but needs to be verified with the author. A result similar to the
   one obtained in the original paper can be obtained by rounding the
   individual differences to two decimal places.

.. [errata-reei-13] Similar to [errata-reei-12]_: The values obtained for all
   the fitting parameters in the original paper (:math:`a_0 =` -0.397903,
   :math:`b_0 =` 1.283059, :math:`c_0 =` -0.5736568, :math:`\rho_0 =`
   1.405425, :math:`\sigma_0 =` 0.147455) differ slightly from the ones
   generated by the tests (:math:`a_0 =` -0.396313, :math:`b_0 =` 1.283062,
   :math:`c_0 =` -0.570292, :math:`\rho_0 =` 1.404094, :math:`\sigma_0 =`
